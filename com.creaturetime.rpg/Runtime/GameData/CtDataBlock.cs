...
namespace CreatureTime
{
    ...
    public static class CtDataBlock
    {
        ...
        private const int WeaponPrefixBitShift = 20;
        private const ulong WeaponPrefixBitMask = 0x0000000000F00000;
        private const ulong WeaponPrefixBitShiftMask = WeaponPrefixBitMask >> WeaponPrefixBitShift;

        private const int WeaponSuffixBitShift = 24;
        private const ulong WeaponSuffixBitMask = 0x000000000F000000;
        private const ulong WeaponSuffixBitShiftMask = WeaponSuffixBitMask >> WeaponSuffixBitShift;

        private const int WeaponReqBitShift = 28;
        private const ulong WeaponReqBitMask = 0x00000000F0000000;
        private const ulong WeaponReqBitShiftMask = WeaponReqBitMask >> WeaponReqBitShift;

        private const int WeaponRarityBitShift = 32;
        private const ulong WeaponRarityBitMask = 0x0000000F00000000;
        private const ulong WeaponRarityBitShiftMask = WeaponRarityBitMask >> WeaponRarityBitShift;
        ...
        public static EWeaponPrefix GetWeaponPrefix(ulong data) =>
            (EWeaponPrefix)((data >> WeaponPrefixBitShift) & WeaponPrefixBitShiftMask);
        ...
        public static void SetWeaponPrefix(EWeaponPrefix prefix, ref ulong data)
        {
            ...
            int p = (int)prefix;
            data = ((ulong)p & WeaponPrefixBitMask) << WeaponPrefixBitShift | data & ~WeaponPrefixBitMask;
        }

        public static EWeaponSuffix GetWeaponSuffix(ulong data) =>
            (EWeaponSuffix)((data >> WeaponSuffixBitShift) & WeaponSuffixBitShiftMask);
        ...
        public static void SetWeaponSuffix(EWeaponSuffix suffix, ref ulong data)
        {
            ...
            int s = (int)suffix;
            data = ((ulong)s & WeaponSuffixBitMask) << WeaponSuffixBitShift | (data & ~WeaponSuffixBitMask);
        }

        public static int GetWeaponRequirement(ulong data) =>
            (int)((data >> WeaponReqBitShift) & WeaponReqBitShiftMask);

        public static EItemRarity GetWeaponRarity(ulong data) =>
            (EItemRarity)((data >> WeaponRarityBitShift) & WeaponRarityBitShiftMask);
            ...
            int requirement, EItemRarity rarity)
        {
            ...
            return
                ...
                ((ulong)ra & WeaponRarityBitShiftMask) << WeaponRarityBitShift | // Rarity
                ((ulong)re & WeaponReqBitShiftMask) << WeaponReqBitShift | // Suffix
                ((ulong)s & WeaponSuffixBitShiftMask) << WeaponSuffixBitShift | // Suffix
                ((ulong)p & WeaponPrefixBitShiftMask) << WeaponPrefixBitShift | // Prefix
        ...
        private const int OffHandPrefixBitShift = 20;
        private const ulong OffHandPrefixBitMask = 0x0000000000F00000;
        private const ulong OffHandPrefixBitShiftMask = OffHandPrefixBitMask >> OffHandPrefixBitShift;

        private const int OffHandSuffixBitShift = 24;
        private const ulong OffHandSuffixBitMask = 0x000000000F000000;
        private const ulong OffHandSuffixBitShiftMask = OffHandSuffixBitMask >> OffHandSuffixBitShift;

        private const int OffHandReqBitShift = 28;
        private const ulong OffHandReqBitMask = 0x00000000F0000000;
        private const ulong OffHandReqBitShiftMask = OffHandReqBitMask >> OffHandReqBitShift;

        private const int OffHandRarityBitShift = 32;
        private const ulong OffHandRarityBitMask = 0x0000000F00000000;
        private const ulong OffHandRarityBitShiftMask = OffHandRarityBitMask >> OffHandRarityBitShift;

        private const int OffHandModifierBitShift = 36;
        private const ulong OffHandModifierBitMask = 0x000000F000000000;
        private const ulong OffHandModifierBitShiftMask = OffHandModifierBitMask >> OffHandModifierBitShift;
        ...
        public static EOffHandPrefix GetOffHandPrefix(ulong data) =>
            (EOffHandPrefix)((data >> OffHandPrefixBitShift) & OffHandPrefixBitShiftMask);
        ...
        public static void SetOffHandPrefix(EOffHandPrefix prefix, ref ulong data)
        {
            ...
            int p = (int)prefix;
            data = ((ulong)p & OffHandPrefixBitMask) << OffHandPrefixBitShift | data & ~OffHandPrefixBitMask;
        }

        public static EOffHandSuffix GetOffHandSuffix(ulong data) =>
            (EOffHandSuffix)((data >> OffHandSuffixBitShift) & OffHandSuffixBitShiftMask);
        ...
        public static void SetOffHandSuffix(EOffHandSuffix suffix, ref ulong data)
        {
            ...
            int s = (int)suffix;
            data = ((ulong)s & OffHandSuffixBitMask) << OffHandSuffixBitShift | (data & ~OffHandSuffixBitMask);
        }

        public static int GetOffHandRequirement(ulong data) =>
             (int)((data >> OffHandReqBitShift) & OffHandReqBitShiftMask);
        ...
        {
            int modifierStat = (int)((data >> OffHandModifierBitShift) & OffHandModifierBitShiftMask);
            return modifierStat + 1;
        }

        public static EItemRarity GetOffHandRarity(ulong data) =>
            (EItemRarity)((data >> OffHandRarityBitShift) & OffHandRarityBitShiftMask);
            ...
            int requirement, EItemRarity rarity, int modifierStat)
        {
            ...
            return
                ...
                ((ulong)modifierStat & OffHandModifierBitShiftMask) << OffHandModifierBitShift | // Modifier Stat
                ((ulong)ra & OffHandRarityBitShiftMask) << OffHandRarityBitShift | // Rarity
                ((ulong)re & OffHandReqBitShiftMask) << OffHandReqBitShift | // Suffix
                ((ulong)s & OffHandSuffixBitShiftMask) << OffHandSuffixBitShift | // Suffix
                ((ulong)p & OffHandPrefixBitShiftMask) << OffHandPrefixBitShift | // Prefix
        ...
        private const ulong ItemUnusedMask = 0xFFFFFFF000000000;

        private const int ItemIdBitShift = 4;
        private const ulong ItemIdBitMask = 0x00000000000FFFF0;
        private const ulong ItemIdBitShiftMask = ItemIdBitMask >> ItemIdBitShift;

        private const int ItemAmountBitShift = 20;
        private const ulong ItemAmountBitMask = 0x0000000FFFF00000;
        private const ulong ItemAmountBitShiftMask = ItemAmountBitMask >> ItemAmountBitShift;

        public static int GetItemId(ulong data) =>
            (int)((data >> ItemIdBitShift) & ItemIdBitShiftMask);

        public static uint GetItemAmount(ulong data) =>
            (uint)((data >> ItemAmountBitShift) & ItemAmountBitShiftMask);

        public static ulong CreateItemData(ushort itemId, uint amount)
        {
            return
                ItemUnusedMask | // Unused
                (amount & ItemAmountBitShiftMask) << ItemAmountBitShift | // Amount
                (itemId & ItemIdBitShiftMask) << ItemIdBitShift | // Currency Type
                ((ulong)EDataType.Item & TypeIdBitMask); // Data type
        }
        ...
        private const ulong CurrencyUnusedMask = 0xFFFFFFF000000000;

        private const int CurrencyIdBitShift = 4;
        private const ulong CurrencyIdBitMask = 0x00000000000FFFF0;
        private const ulong CurrencyIdBitShiftMask = CurrencyIdBitMask >> CurrencyIdBitShift;

        private const int CurrencyAmountBitShift = 20;
        private const ulong CurrencyAmountBitMask = 0x000FFFFFFFF00000;
        private const ulong CurrencyAmountBitShiftMask = CurrencyAmountBitMask >> CurrencyAmountBitShift;

        public static int GetCurrencyType(ulong data) =>
            (int)((data >> CurrencyIdBitShift) & CurrencyIdBitShiftMask);

        public static uint GetCurrencyAmount(ulong data) =>
            (uint)((data >> CurrencyAmountBitShift) & CurrencyAmountBitShiftMask);

        public static ulong CreateCurrencyData(ushort currencyId, uint amount)
        {
            return
                CurrencyUnusedMask | // Unused
                (amount & CurrencyAmountBitShiftMask) << CurrencyAmountBitShift | // Amount
                (currencyId & CurrencyIdBitShiftMask) << CurrencyIdBitShift | // Currency Type
                ((ulong)EDataType.Currency & TypeIdBitMask); // Data type
        }
        ...
        private const int EffectSourceBitShift = EffectIdBitShift + 16;
        private const ulong EffectSourceBitMask = 0x00000000FFFF0000;
        private const ulong EffectSourceBitShiftMask = EffectSourceBitMask >> EffectSourceBitShift;

        private const int EffectTurnsBitShift = EffectSourceBitShift + 16;
        private const ulong EffectTurnsBitMask = 0x000000FF00000000;
        private const ulong EffectTurnsBitShiftMask = EffectTurnsBitMask >> EffectTurnsBitShift;
        ...
        public static ushort GetEffectSource(ulong data) =>
            (ushort)((data >> EffectSourceBitShift) & EffectSourceBitShiftMask);

        public static int GetEffectTurns(ulong data) =>
            (int)((data >> EffectTurnsBitShift) & EffectTurnsBitShiftMask);
        ...
        public static void SetEffectTurns(int turns, ref ulong data)
        {
            ...
            data = ((ulong)turns & EffectTurnsBitShiftMask) << EffectTurnsBitShift | data & ~EffectTurnsBitMask;
        }
        ...
        public static ulong CreateEffectData(ushort identifier, ushort sourceId, int turns)
        {
            ...
            return
                ...
                ((ulong)turns & EffectTurnsBitShiftMask) << EffectTurnsBitShift | // Turns
                (sourceId & EffectSourceBitShiftMask) << EffectSourceBitShift | // Source Identifier
