...
namespace CreatureTime
{
    ...
    public class CtGameData : CtSingleton
    {
        ...
        [SerializeField] private CtLootTable[] lootTables;
        ...
        public CtLootTable[] LootTables => lootTables;
        ...
        private DataDictionary _lootTables = new DataDictionary();
        ...
        public bool TryGetLootTable(ushort identifier, out CtLootTable lootTable)
        {
            lootTable = null;
            ...
            lootTable = (CtLootTable)dataToken.Reference;
            return true;
        }
    }
}