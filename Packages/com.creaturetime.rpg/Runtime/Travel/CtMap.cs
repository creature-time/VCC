...
namespace CreatureTime
{
    ...
    public class CtMap : CtAbstractSignal
    {
        ...
        [UdonSynced, FieldChangeCallback(nameof(_Callback_LocationId))] private ushort locationId = CtConstants.InvalidId;
        ...
        public ushort _Callback_LocationId
        {
            ...
            {
                locationId = value;
                if (locationId == CtConstants.InvalidId)
                {
                    LocationDef = null;
                    return;
                }
        ...
        public Vector2Int[] Edges => edges;
        public int Current => current;
        public int Last => completed.Length > 0 ? completed[completed.Length - 1] : -1;
        public CtLocationDef LocationDef { get; private set; }
        ...
        private void _GenerateNodes(int nodeCount, DataList nodeOptions)
        {
            ...
            nodes[1] = new Vector2(mid, Length);
            ...
            for (var i = 2; i < nodeCount; ++i)
            {
                ...
                nodes[i] = new Vector2(nodeChoice % Width, Mathf.RoundToInt(nodeChoice / (float)Width));
            }
        }
        ...
        public void GenerateMap(CtLocationDef locationDef, int width, int length, int pathCount)
        {
            LocationId = locationDef.Identifier;
            ...
            var nodeCount = Mathf.Max(Width * Length / pathCount, 1);
        ...
        public override void OnDeserialization()
        {
            ...
            {
                edges[i] = new Vector2Int(paths[i * 2], paths[i * 2 + 1]);
            }
