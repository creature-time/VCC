...
namespace CreatureTime
{
    ...
    public class CtPartyManagerViewTest : CtAbstractSignal
    {
        ...
        public void _OnMemberAdded()
        {
            ...
            _partyPrefabs.Add(entity.Identifier, prefab);
#if DEBUG_LOGS
            _Debug_PrintPrefabs();
#endif
            ...
            entity.Connect(EEntitySignal.EntityDefChanged, this, nameof(_OnIdentifierChanged));
        }
        ...
        public void _OnMemberRemoved()
        {
            ...
            var entity = party.GetEntity(index);
            entity.Disconnect(EEntitySignal.EntityDefChanged, this, nameof(_OnIdentifierChanged));

            if (!_partyPrefabs.TryGetValue(entity.Identifier, out var token))
            {
#if DEBUG_LOGS
                LogCritical($"[_OnMemberRemoved] Failed to find prefab (identifier={entity.Identifier}).");
#endif
                return;
            }
            ...
            _partyPrefabs.Remove(entity.Identifier);
#if DEBUG_LOGS
            _Debug_PrintPrefabs();
#endif
        }
